...
## TODO(SJ): Refactor this file to match ours
...
from Simulation.pybullet.imm.motion_planners.meta import solve
...
DARK_GREY = RGBA(0.4, 0.4, 0.4, 1)
TRANSPARENT_GREY = RGBA(0.5, 0.5, 0.5, 0.3)
YELLOW = RGBA(1, 1, 0, 1)
...
def connect(use_gui=True, shadows=True, color=None, width=None, height=None, mp4=None, fps=120):
    ...
    ## EXP (SJ): Most interactive features are disabled for speed reasons. 
    # if use_gui:
    ...
    #    p.COV_ENABLE_DEPTH_BUFFER_PREVIEW: 1,
    #    p.COV_ENABLE_SEGMENTATION_MARK_PREVIEW: 1,
